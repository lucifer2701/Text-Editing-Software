...
main_application.title('A-Square Text Edtor')
...
## translator
translate_icon = tk.PhotoImage(file='icons2/trans.png')
translate_btn = ttk.Button(tool_bar, image=translate_icon)
translate_btn.grid(row=0, column=9, padx=5)

## credit
credit_icon= tk.PhotoImage(file='icons2/credit.png')
credit_btn = ttk.Button(tool_bar, image=credit_icon)
credit_btn.grid(row=0, column=10, padx=5)
...
translate_btn.configure(command=translate)
